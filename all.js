riot.tag2('auto-complete-input', '<p> <input type="text" oninput="{change}" value="{query}"> </p>', '', '', function(opts) {
    var that=this
...
riot.tag2('results', '<div each="{result in filteredResults}"> <result result="{result}" index="{result.index}"></result> </div>', '', '', function(opts) {
